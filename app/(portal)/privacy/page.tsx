      ...
      <main className="p-form-area">
        <div className="p-container-xs">
          <div className="p-form-card" style={{ padding: "40px 36px", display: "flex", flexDirection: "column", gap: "2rem" }}>
            ...
            <section style={SECTION_STYLE}>
              ...
              <ul style={UL_STYLE}>
                <li>
                  ...
                  このデータは通常、利用者のブラウザ内にのみ保存され、外部に送信されることはありません。
                  アカウントにログインしている場合のみ、端末間の同期のために当サイトのサーバーへ保存されます（第3条参照）。
            ...
            <section style={SECTION_STYLE}>
              <h2 style={H2_STYLE}>3. アカウント機能（Google ログイン）</h2>
              <p style={P_STYLE}>
                当サイトでは、Google アカウントによるログイン機能を提供しています。
                ログインは任意です。ログインしなくても、すべてのツール・コンテンツをそのまま利用できます。
              </p>
              <p style={P_STYLE}>
                ログイン時に Google から取得する情報は、<strong>ユーザーを識別するための一意のID（sub）のみ</strong>です。
                メールアドレス・氏名・プロフィール画像などは一切取得しません。
              </p>
              <p style={P_STYLE}>
                サイト内で表示する名前（ニックネーム）は、利用者がご自身で設定するものです。
                Google アカウントの名前とは無関係で、他の利用者に Google アカウントが知られることはありません。
              </p>
              <p style={P_STYLE}>
                ログイン中は、以下のデータをアカウントに保存します。
                これらは端末間の同期・データの保存のためにのみ使用し、第三者への提供は行いません。
              </p>
              <ul style={UL_STYLE}>
                <li>ニックネーム</li>
                <li>ツールの利用履歴・設定（カウンターの記録・電卓の計算履歴など）</li>
                <li>ゲームのセーブデータ</li>
              </ul>
              <p style={P_STYLE}>
                アカウントはいつでも削除できます。削除すると、ニックネーム・利用履歴・セーブデータを含む
                保存データはすべて即時削除されます。
              </p>
            </section>
            ...
            <section style={SECTION_STYLE}>
              ...
              <p style={P_STYLE}>
                ただし、お問い合わせ対応・アクセス解析・アカウント認証（ログイン）のために以下の外部サービスを利用しています。
              ...
              <table style={TABLE_STYLE}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td style={TD_STYLE}>Google ログイン（OAuth）</td>
                    <td style={TD_STYLE}>Google LLC</td>
                    <td style={TD_STYLE}>アカウント認証</td>
                  </tr>
                  <tr>
