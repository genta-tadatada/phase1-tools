    ...
    <>
      ...
      <header className="p-header">
        <div className="p-header-inner">
          <Link href="/portal" className="p-logo">TADATADA</Link>
          <PortalSiteNav currentPath="/portal" />
        </div>
      </header>
      ...
      <section className="p-services" id="services">
        <div className="p-container">
          ...
          <div className="p-service-grid">
            <a href="https://tadatools.pages.dev" className="p-service-card live">
          ...
          <div className="p-feat-grid">
            <div className="p-feat-card">
              <div className="p-feat-icon i-1">
                <img src="/uploads/kawaii-check-circle.svg" alt="" width={32} height={32} />
              </div>
            ...
            <div className="p-feat-card">
              <div className="p-feat-icon i-2">
                <img src="/uploads/kawaii-unlock.svg" alt="" width={32} height={32} />
              </div>
            ...
            <div className="p-feat-card">
              <div className="p-feat-icon i-3">
                <img src="/uploads/kawaii-price-tag-zero.svg" alt="" width={32} height={32} />
              </div>
            ...
            <div className="p-feat-card">
              <div className="p-feat-icon i-4">
                <img src="/uploads/kawaii-megaphone-mute.svg" alt="" width={32} height={32} />
              </div>
