        ...
        <div style={{ maxWidth:896, margin:"0 auto", padding:"0 24px", position:"relative" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:10 }}
            ...
            {visible.map((tool) => (
              ...
              >
                <div className="tool-icon-inner" style={{ position:"relative", width:64, height:64, borderRadius:14, display:"inline-flex", alignItems:"center", justifyContent:"center", marginBottom:12, background:catIconBg[tool.cat] }}>
                  <Image src={tool.icon} alt="" width={52} height={52} style={{ objectFit:"contain", mixBlendMode:"multiply" }} />
