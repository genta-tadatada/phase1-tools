...
export const NEWS_DATA: NewsItem[] = [
  ...
  },
  {
    ...
    body: "「無料のくせに広告だらけ」「ちょっと使いたいだけなのにアカウント登録が必要」— そんな体験への不満からTADATADAをつくりました。\n\nTADATADAのすべてのサービスは、アカウント登録なし・ログインなしで使えます。広告はページ下部の細いバナーのみ。ツールの操作中・ゲームプレイ中には表示しません。これからもずっとタダで使えるサービスを目指します。",
