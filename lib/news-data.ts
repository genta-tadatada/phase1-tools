...
export const NEWS_DATA: NewsItem[] = [
  {
    ...
    date: "2026-06-19",
    category: "アップデート",
    title: "ホーム画面に追加してアプリのように使えるようになりました",
    summary: "スマホ・PCのホーム画面に追加すると、ブラウザを開かずアプリのように起動できます。",
    body: "ただただがPWA（プログレッシブウェブアプリ）に対応しました。スマートフォン・PCのホーム画面に追加して、アプリのように起動できます。\n\n主な利点は以下のとおりです。\n\n・ブラウザを開く手間なしでツール画面が直接開きます\n・全画面表示でアドレスバー・タブが非表示になり、ツールに集中できます\n・オフラインでも一部の機能が動作します（ネット接続なしでも開けます）\n・アプリストアからのインストール・アカウント登録は不要です\n\nスマートフォンでの追加方法：ブラウザでただただ（tadatada.net）を開き、共有メニュー（iOS）またはメニュー（Android）から「ホーム画面に追加」を選択してください。\n\nPCでの追加方法：Chrome・Edge等のアドレスバー右側に表示されるインストールアイコンをクリックしてください。",
    banner: { grad: ["#fce7f3", "#fbcfe8", "#e9d5ff"], icon: "📱" },
  ...
  },
  {
    ...
    summary: "ご意見・ご要望・不具合のご報告など、お気軽にお送りください。",
    body: "ただただにお問い合わせフォームを設置しました。\n\nツールの使い方に関するご質問、不具合のご報告、機能のご要望などがあればお気軽にどうぞ。\n\nフォームはページ下部のメニュー、またはこちらのリンクからご利用いただけます。\n\n・カテゴリを選んで送信するだけの簡単な仕組みです\n・返信を希望される方は、メールアドレスをご入力ください\n・いただいたご意見はサービス改善の参考にさせていただきます\n\nいただいたメッセージへの返信にはお時間をいただく場合があります。あらかじめご了承ください。",
    banner: { grad: ["#fce7f3", "#fbcfe8", "#ddd6fe"], icon: "✉️" },
    image: "/uploads/banner-megaphone.png",
  },
  {
    id: "011",
    date: "2026-06-19",
    category: "お知らせ",
    title: "プライバシーポリシーを制定しました",
    summary: "当サイトにおける情報の取り扱いについて、プライバシーポリシーを正式に制定しました。",
    body: "ただただのプライバシーポリシーを正式に制定し、公開しました。\n\n主な内容は以下のとおりです。\n\n・収集する情報の種類（LocalStorage・Cookie・アクセスログ）\n・お問い合わせフォームから取得する情報の取り扱い\n・アクセス解析・広告配信のための外部サービス利用予定\n・ユーザーの権利（開示・訂正・削除のご請求）\n\n当サイトのツールはログイン不要でお使いいただけ、氏名・住所などの個人情報は取得しません（お問い合わせで返信をご希望の場合のみ、任意でメールアドレスをいただきます）。LocalStorageに保存されるツールの状態データは、すべてお使いのブラウザ内にのみ保存され、外部に送信されることはありません。\n\nプライバシーポリシーの全文はページ下部のリンクよりご確認いただけます。\n\n今後サービスの変更やサービスの追加にともない、ポリシーを更新する場合はお知らせページでご案内します。",
    banner: { grad: ["#ede9fe", "#ddd6fe", "#bfdbfe"], icon: "📋" },
  ...
  },
  {
    ...
    summary: "無料で遊べるブラウザゲームを開発中です。詳細は続報でお知らせします。",
    body: "ただただの3つ目のサービス「ただタダgames」を開発中です。\n\nブラウザで手軽に遊べるゲームを目指しています。詳細な内容は続報でお知らせします。",
  ...
  },
  {
    ...
    date: "2026-06-19",
    category: "お知らせ",
    title: "タダtools — 全ツール一覧",
    summary: "カウンターから抽選・計算まで。タダtoolsの全ラインナップをご紹介します。",
    body: "タダtoolsでは以下のツールを順次公開しています。\n\nマルチカウンター・ストップウォッチ・タイマー・BPMメトロノーム・履歴付き電卓・文字数カウント・ランダム数字・サイコロ・ルーレット・じゃんけん・くじ引き・グループ分け・あみだくじ・トーナメント表・スライド背景\n\nすべてログイン不要・完全無料でお使いいただけます。",
  ...
  },
  {
    ...
    date: "2026-06-19",
    category: "お知らせ",
    title: "ただただのポリシー：個人情報は最小限・広告控えめ・すべて無料",
    summary: "使うたびに広告が邪魔、不要な個人情報を求められる…そんなストレスをなくしたいと思ってつくりました。",
    body: "「無料のくせに広告だらけ」「ちょっと使いたいだけなのに会員登録が必要」— そんな体験への不満からただただをつくりました。\n\nただただのツール・一問一答は、アカウント登録なしでお使いいただけます。広告は必要最小限にとどめ、サービスの使用を妨げない形で表示します。取得する個人情報も必要最小限にとどめ、これからもずっとタダで使えるサービスを目指します。",
